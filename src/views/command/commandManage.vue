<template>
  <div style="padding: 10px">
    ...
    >
      ...
      <el-table-column label="指令名称" min-width="150px" prop="name"></el-table-column>
      <el-table-column label="指令方法" min-width="150px" prop="date"></el-table-column>
      <el-table-column label="适用公司" min-width="200px" prop="voltageH"></el-table-column>
