<template>
  <div style="padding: 10px">
    ...
    >
      ...
      <el-table-column label="控制器编号" min-width="150px" prop="date"></el-table-column>
      <el-table-column label="控制器名称" min-width="150px" prop="batType"></el-table-column>
      <el-table-column label="备注" min-width="200px" prop="expType"></el-table-column>
      <el-table-column label="创建时间" min-width="200px" prop="voltageH"></el-table-column>
      <el-table-column label="设备ID" min-width="200px" prop="voltageL"></el-table-column>
      <el-table-column label="设备token" min-width="200px" prop="current"></el-table-column>
